...
#[ORM\UniqueConstraint(name: 'uniq_aromatic_groups_translation_slug', columns: ['locale', 'slug'])]
#[ORM\Index(name: 'idx_aromatic_groups_translation_locale', columns: ['locale'])]
class AromaticGroupsTranslation implements TranslationInterface, Sluggable
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
