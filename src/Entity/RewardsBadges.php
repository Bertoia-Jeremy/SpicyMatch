...
use App\Repository\RewardsBadgesRepository;
...
#[ORM\Entity(repositoryClass: RewardsBadgesRepository::class)]
class RewardsBadges
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToMany(targetEntity: Users::class, inversedBy: 'rewardsBadges')]
