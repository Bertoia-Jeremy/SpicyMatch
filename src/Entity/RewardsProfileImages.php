...
use App\Repository\RewardsProfileImagesRepository;
...
#[ORM\Entity(repositoryClass: RewardsProfileImagesRepository::class)]
class RewardsProfileImages
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToMany(targetEntity: Users::class, inversedBy: 'rewardsProfileImages')]
    ...
    public function setDeleted_at(?\DateTimeInterface $deleted_at): static
    {
