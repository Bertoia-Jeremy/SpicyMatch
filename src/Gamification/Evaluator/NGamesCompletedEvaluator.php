...
final class NGamesCompletedEvaluator implements TriggerEvaluatorInterface, ProgressTrackableEvaluator
{
    public function trigger(): AchievementTrigger
    {
        return AchievementTrigger::N_GAMES_COMPLETED;
    }
    ...
    public function isMet(Achievement $achievement, UserProgression $progression, array $context): bool
    {
        return ContextFilter::matches($achievement, $context)
            && ((int) ($context['gamesCompleted'] ?? 0)) >= $achievement->getTriggerValue();
    }
}
